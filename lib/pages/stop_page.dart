...
import 'package:stop_flutter/pages/tutorial_page.dart';
  ...
  void initState() {
    ...
    WidgetsBinding.instance?.addPostFrameCallback((_) async{
      ...
      if(prefs.getBool('isFirstLaunch') ?? true){
        await Navigator.pushNamed(context, Tutorial.id);
      }
     });
    final workMinuts = 0;
        ...
        body: SafeArea(
          child: Column(
              ...
              children: <Widget>[
                ...
                Text('もう一度',style: TextStyle(fontSize:26.0,color: Colors.blue ),), //stop2.dartには追加
                Text('ゆっくりと呼吸をしよう',
